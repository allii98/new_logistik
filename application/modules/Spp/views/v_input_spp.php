                ...
                <div class="card-body">
                    <div class="row justify-content-between headspp">
                        ...
                        <div class="button-list">
                            <button class="btn btn-xs btn-success mr-1" id="new_spp" onclick="new_spp()" disabled>Input SPP</button>
                            <button class="btn btn-xs btn-danger mr-1" id="cancelSpp" onclick="hapusSpp()" disabled>Batalkan SPP</button>
                            <button class="btn btn-danger btn-xs" id="a_print_spp" onclick="cetak_spp()">Cetak</button>
