...
class M_cari_bkbitem extends CI_Model
{
      ...
      var $column_order = array(null, 'id', 'kodebar', 'nabar', 'grp', 'satuan', 'qty2', 'afd', 'blok', 'kodebeban', 'ketbeban', 'kodesub', 'ketsub', 'kode_dev', 'txtperiode'); //field yang ada di table user
      var $column_search = array('id', 'kodebar', 'nabar', 'grp', 'satuan', 'qty2', 'afd', 'blok', 'kodebeban', 'ketbeban', 'kodesub', 'ketsub', 'kode_dev', 'txtperiode'); //field yang diizin untuk pencarian 
