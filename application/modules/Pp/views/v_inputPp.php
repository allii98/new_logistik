    ...
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="widget-rounded-circle card-box">
                <h4 class="header-title mb-3">Input PP</h4>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group row mb-1">
                            <label class="col-4 col-form-label">Ref PO *</label>
                            <div class="col-7">
                        ...
                        <div class="form-group row mb-1">
                            <label class="col-4 col-form-label">Nilai PO</label>
                            <div class="col-7">
                        ...
                        <div class="form-group row mb-1">
                            <label class="col-4 col-form-label">Kurs</label>
                        ...
                        <div class="form-group row mb-1">
                            <label class="col-4 col-form-label">Pajak</label>
                            <div class="col-7">
                        ...
                        <br>
                        <div class="form-group row mb-1">
                            <label class="col-4 col-form-label">Nilai BPO</label>
                            <div class="col-7">
                                <input id="txt_nilai_bpo1" name="txt_nilai_bpo1" class="form-control col-xs-12 mb-1 currencyduadigit" required="required" type="text" value="0.00" placeholder="Nilai BPO1" onkeyup="hitungTotalPO()">
                                <input id="txt_nilai_bpo2" name="txt_nilai_bpo2" class="form-control col-xs-12 currencyduadigit" required="required" type="text" value="0.00" placeholder="Nilai BPO2" onkeyup="hitungTotalPO()">
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div>
                            <label class="col-md-12 col-sm-3 col-xs-12 row mb-1">User : User SITE</label>
                        </div>
                        <div class="form-group row mb-1">
