...
<script>
    ...
    //     $('#tmpo_pembayaran,#tmpo_pengiriman').number(true);
    //     $('#txt_uang_muka,#ttl_pembayaran,#pph,#txt_qty_1,#txt_harga_1,#txt_disc_1,#txt_biaya_lain_1,#txt_jumlah_1').number(true, 2);
