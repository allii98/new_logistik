...
class M_data extends CI_Model
{
    ...
    var $column_order = array(null, 'id', 'no_refppo', 'nopo', 'tglpo', 'nama_supply', 'ket', 'terbayar'); //field yang ada di table supplier  
    ...
    {
        // $Value = ;
        $this->db_logistik_pt->select('id, no_refppo , nopo, tglpo, nama_supply, ket, terbayar');
