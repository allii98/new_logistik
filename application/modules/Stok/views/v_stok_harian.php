    ...
    <div class="col-md">
        <div class="widget-rounded-circle card-box">
            <div class="row justify-content-between">
                <h4 class="header-title" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">Stock Awal Harian</h4>
                    ...
                    <table id="tableStockAwal_harian" class="table w-100 dataTable no-footer table-sm table-striped">
                        ...
                        <thead class="thead-light">
                            <tr role="row">
                                ...
                                <th rowspan="2" class="align-middle sorting_asc" tabindex="0" aria-controls="complex-header-datatable" colspan="1" style="width: 239.4px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Tanggal</th>
