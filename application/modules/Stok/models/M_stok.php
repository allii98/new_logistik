...
class M_stok extends CI_Model
{
    ...
    var $column_order = array(null, 'id', 'kodebartxt', 'nabar', 'satuan', 'grp', 'saldoawal_qty', 'QTY_MASUK', 'saldoawal_nilai', 'saldoakhir_qty', 'saldoakhir_nilai', 'nilai_masuk', 'ket', 'minstok'); //field yang ada di table supplier  
    var $column_search = array('kodebartxt', 'nabar', 'satuan', 'grp', 'saldoawal_qty', 'saldoawal_nilai', 'QTY_MASUK', 'saldoakhir_qty', 'saldoakhir_nilai', 'nilai_masuk', 'ket', 'minstok'); //field yang diizin untuk pencarian 
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db_logistik_pt->select('id, kodebartxt, nabar, satuan, grp, saldoawal_qty, saldoawal_nilai, saldoakhir_qty,QTY_MASUK, saldoakhir_nilai,nilai_masuk, ket, minstok');
