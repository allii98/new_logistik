...
<div class="row justify-content-center">
    <div class="col-md col-xl-3">
        <div class="widget-rounded-circle card-box">
            <h4 class="header-title mb-3">Input BPB</h4>
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <label class="control-label col-md col-sm-3 col-xs-12">Tgl BPB <span class="required">*</span>
                    </label>
                    <div class="col-md col-sm-6 col-xs-12">
                        <input id="txt_tgl_bpb" name="txt_tgl_bpb" class="form-control bg-light" required="required" type="date" value="<?= date('Y-m-d') ?>" readonly>
                    </div>
                </div>
